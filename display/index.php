...
window.onload=changeImg;
    ...
    <table border="1" style="width: 100%; ">
        ...
        <tr>
            <td colspan="2" style="font-size :200%; text-align :center; padding-top: .5%;vertical-align: top" width="25%">
            ...
            <td colspan="2" style=" height:300px; align-content: center" width="25%">
        ...
        <tr style="height:80%;">
            <td colspan="2" style="width:25%; padding: .2%; align-content: center">
            ...
            <td colspan="2" style="width:25%; padding: .2%">
                    <iframe src="https://www.youtube.com/embed/4_PfSD7uw0M?autoplay=1&controls=0&loop=1&mute=1&playlist=4_PfSD7uw0M&amp;theme=light&amp;autohide=1&amp;showinfo=0" width="100%" height="100%" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
            </td>
